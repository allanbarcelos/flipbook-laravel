...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <form class="form" action="{{route('user_change_password')}}" method="post">
            ...
            <div class="form-group row">
                <label class="col-md-3 control-label"  for="oldPassword">Senha antiga</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label class="col-md-3 control-label"  for="newPassword">Nova senha</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label class="col-md-3 control-label"  for="rptNewPassword">Repita a senha</label>
                <div class="col-md-9">
